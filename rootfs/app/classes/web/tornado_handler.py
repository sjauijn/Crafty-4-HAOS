...
class Webserver:
    ...
    def run_tornado(self):
        ...
        logger.info(f"Starting Web Server on port http:{http_port}")
        ...
        self.http_server = tornado.httpserver.HTTPServer(app, xheaders=True)
        self.http_server.listen(http_port, address="127.0.0.1")
